...
var GridStackEngine = class _GridStackEngine {
  ...
  */
  save(saveElement = true, saveCB, column) {
    var _a;
    const len = ((_a = this._layouts) == null ? void 0 : _a.length) || 0;
    let layout;
    if (len) {
      if (column) {
...
var DDDraggable = class _DDDraggable extends DDBaseImplement {
  ...
  _setupHelperStyle(e) {
    ...
    (_b = (_a = this.el.gridstackNode) == null ? void 0 : _a.grid) == null ? void 0 : _b.el.classList.add("grid-stack-dragging");
  ...
  _removeHelperStyle() {
    ...
    (_b = (_a = this.el.gridstackNode) == null ? void 0 : _a.grid) == null ? void 0 : _b.el.classList.remove("grid-stack-dragging");
    const node = (_c = this.helper) == null ? void 0 : _c.gridstackNode;
